...
class CBlock extends StatelessWidget {
  ...
  Widget _buildTripSection(String title, String startLocation, String endLocation, String startTime, String endTime) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Center(
        ...
        _buildDividerLine(),
        _buildLocationRow(endLocation, endTime, Colors.green),
