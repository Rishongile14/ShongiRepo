import 'package:driverapp/passengers_booked.dart';
...
class Block extends StatelessWidget {
  ...
  Widget build(BuildContext context){
    ...
    final driver_id = driverProvider.driver.id;
    return Padding(
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () => BookedPassengers(driver_id: driver_id, trip_id: tripInfo['trip_id'] ),
                      ),
                    )
                  ],
                ),
